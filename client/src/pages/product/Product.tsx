...
export default function Product() {
  ...
  return (
    <main className="flex flex-col justify-center items-center w-full lg:px-24">
      ...
      <section className="flex flex-col lg:flex-row gap-12 justify-center p-5 mb-12 bg-bg-neutral w-full py-32">
        ...
        <div className="flex flex-col gap-8 lg:w-4/5 w-full justify-start py-4">
          ...
          <div className="flex flex-col justify-center items-center gap-8">
            <span className="font-light text-md flex gap-3 flex-col">
              ...
              {pagination?.itemCount} item{pagination?.itemCount > 1 && 's'}
            </span>
            <Button
              variant="primary"
              className="w-40"
